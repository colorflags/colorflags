...
-- play        	
          stopBtn = display.newText("Mute", _W*(3/4)+10, _H*(4/5), "federalescort3d", 35 ) 
          jamBtn = display.newText("MuSic",_W*(1/4)-15, _H*(4/5) , "federalescort3d", 35 )                      
          if soundOn==false then
            media.playSound(music)
            soundOn=true
            print("music")
          end
          playBtn = display.newText("AntheM", _W/2-10, _H*(4/5), "federalescortchrome", 35 )          
          transition.to(playBtn,{time=50, xScale=1.2,yScale=1.2,onComplete=phase2})        
        elseif e.target==stopBtn then
-- stop        	
          playBtn = display.newText("AntheM", _W/2-10, _H*(4/5), "federalescort3d", 35 )         
          jamBtn = display.newText("MuSic", _W*(1/4)-15, _H*(4/5), "federalescort3d", 35 )
          ...
          stopBtn = display.newText("Mute", _W*(3/4)+10, _H*(4/5), "federalescortchrome", 35 )          
          transition.to(stopBtn,{time=50, xScale=1.2,yScale=1.2,onComplete=phase2})       
        elseif e.target==jamBtn then
-- anthem        	
          stopBtn = display.newText("Mute", _W*(3/4)+10, _H*(4/5), "federalescort3d", 35 )      
          playBtn = display.newText("AntheM", _W/2-10, _H*(4/5), "federalescort3d", 35 )
          jamBtn = display.newText("MuSic", _W*(1/4)-15, _H*(4/5), "federalescortchrome", 35 )
          ffBtn = display.newText(">>", (_W*(1/6))+60, _H*(2/3), "federalescortchrome", 35 )      
          rwBtn = display.newText("<<", _W*(1/6), _H*(2/3), "federalescortchrome", 35 )
...
-- wide        	
            ...
            heightModeTop=35
            heightModeLow=_H-35     
            phaseNarrowBtn = display.newText("nArrow", _W*(3/4) ,_H*(1/6), "federalescort3d", 35 ) 
            phaseWideBtn = display.newText("wide", _W*(1/5), _H*(1/6) , "federalescortchrome", 35 )
...
-- narrow        	
            ...
            heightModeTop=70
            heightModeLow=_H-70  
            phaseWideBtn = display.newText("wide", _W*(1/5) ,_H*(1/6) , "federalescort3d", 35 )  
            phaseNarrowBtn = display.newText("nArrow",_W*(3/4) ,_H*(1/6), "federalescortchrome", 35 )
...
function scene:show( event )
  ...
  if event.phase == "will" then
   ...
   infoYesBtn = display.newText("Yes", _W*(1/5),_H*(1/2), "federalescorted", 35)
   ...
   infoNoBtn = display.newText("No", _W*(3/4),_H*(1/2), "federalescorted", 35)
