...
-- physics.start()
-- media.playSound('music/brazil.mid')

-- local soundEffect = audio.loadSound( "mech-clamp.wav" )
...
local startScore=0
local scoreText = display.newText(score, _W*(4/5), _H/2, native.systemFont, 28)
...
local function finishScale()
    ...
    --      if state ~= 3 then
    timerSpeed=timer.performWithDelay(5000,speedUp,3)
    --   else
